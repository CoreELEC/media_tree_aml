...
AVL_ErrorCode AVL62X1_GetChipID(AVL_uint16 slave_addr, AVL_puint32 pChipId)
{
  ...
  r = II2C_Read32_AVL62X1(slave_addr, 0x40000, pChipId);
  return (r);
}
...
AVL_ErrorCode AVL62X1_LockTP(struct AVL62X1_CarrierInfo *pCarrierInfo, struct AVL62X1_StreamInfo *pStreamInfo, AVL_bool blind_sym_rate, struct AVL62X1_Chip *pAVL_Chip)
{
  ...
  static AVL_uchar AGC_enabled = 0;
  ...
  if (pStreamInfo != nullptr)
  {
    ...
    r |= II2C_Write16_AVL62X1(pAVL_Chip->usI2CAddr, c_AVL62X1_SP_S2X_sp_t2mi_ts_pid_saddr_cur, pStreamInfo->m_T2MI_PID); // Must set the T2MI PID for T2MI signal ,general value :0x1000
  }
  else
  {
...
AVL_ErrorCode AVL62X1_GetStreamList(struct AVL62X1_StreamInfo *pStreams, const AVL_uchar max_num_streams, struct AVL62X1_Chip *pAVL_Chip)
{
  ...
  AVL_uint32 stream_list_ptr_2 = 0;
  ...
  r |= II2C_Read32_AVL62X1(pAVL_Chip->usI2CAddr, s_AVL62X1_SP_S2X_sp_DVB_STREAM2_addr_iaddr, &stream_list_ptr_2);
  ...
  for (stream = 0; stream < num_streams; stream++)
  {
    ...
    if (pStreams[stream].m_stream_type == AVL62X1_T2MI)
    {
      ...
      r |= II2C_Read16_AVL62X1(pAVL_Chip->usI2CAddr, stream_list_ptr_2 + stream * 4, &tmp16);
...
AVL_ErrorCode AVL62X1_GetSignalInfo(struct AVL62X1_CarrierInfo *pCarrierInfo, struct AVL62X1_Chip *pAVL_Chip)
{
  ...
  pCarrierInfo->m_carrier_freq_offset_Hz += (AVL_int32)uiTemp;
  pCarrierInfo->m_carrier_freq_offset_Hz -= iCarrierFreqOffSet;
...
AVL_ErrorCode AVL62X1_Enable_T2MIRawMode(struct AVL62X1_Chip *pAVL_Chip)
{
  ...
  r |= II2C_Write8_AVL62X1(pAVL_Chip->usI2CAddr, c_AVL62X1_SP_S2X_sp_raw_t2mi_mode_caddr, 1);
...
AVL_ErrorCode AVL62X1_Disable_T2MIRawMode(struct AVL62X1_Chip *pAVL_Chip)
{
  ...
  r |= II2C_Write8_AVL62X1(pAVL_Chip->usI2CAddr, c_AVL62X1_SP_S2X_sp_raw_t2mi_mode_caddr, 0);
...
AVL_ErrorCode AVL62X1_GetPLSXLFSRValue(AVL_puint32 pXLFSRValue, struct AVL62X1_Chip *pAVL_Chip)
{
  ...
  r |= II2C_Read32_AVL62X1(pAVL_Chip->usI2CAddr, s_AVL62X1_S2X_PLScramKey_iaddr, pXLFSRValue);
...
AVL_ErrorCode AVL62X1_Manual_Set_T2MI_PID(AVL_uint16 T2MI_PID, struct AVL62X1_Chip *pAVL_Chip)
{
  ...
  r |= II2C_Write16_AVL62X1(pAVL_Chip->usI2CAddr, c_AVL62X1_SP_S2X_sp_t2mi_ts_pid_saddr, T2MI_PID); //default value 0x1000 //Set T2MI ID
...
AVL_ErrorCode AVL62X1_Manual_Set_T2MI_PID_1(AVL_uint16 T2MI_PID, struct AVL62X1_Chip *pAVL_Chip)
{
  ...
  r |= II2C_Write16_AVL62X1(pAVL_Chip->usI2CAddr, c_AVL62X1_SP_S2X_sp_t2mi_ts_pid_saddr_1, T2MI_PID); //default value 0x40 //Set T2MI ID
...
AVL_ErrorCode AVL62X1_AutoDetect_T2MI_PID_Enable(struct AVL62X1_Chip *pAVL_Chip)
{
  ...
  r |= II2C_Write16_AVL62X1(pAVL_Chip->usI2CAddr, c_AVL62X1_SP_S2X_sp_t2mi_ts_pid_detect_auto_en, 1); //default value 0
...
AVL_ErrorCode AVL62X1_Get_Current_Stream_T2MI_PID(AVL_puint16 puiT2MI_PID, struct AVL62X1_Chip *pAVL_Chip)
{
  ...
  r |= II2C_Read16_AVL62X1(pAVL_Chip->usI2CAddr, c_AVL62X1_SP_S2X_sp_t2mi_ts_pid_saddr_cur, puiT2MI_PID); //Get current T2MI stream T2MI PID
...
AVL_ErrorCode AVL62X1_Set_Current_Stream_T2MI_PID(AVL_uint16 uiT2MI_PID, struct AVL62X1_Chip *pAVL_Chip)
{
  ...
  r |= II2C_Write16_AVL62X1(pAVL_Chip->usI2CAddr, c_AVL62X1_SP_S2X_sp_t2mi_ts_pid_saddr_cur, uiT2MI_PID); //Set current T2MI stream T2MI PID
...
AVL_ErrorCode AVL62X1_Set_T2MI_MPLP_id_ScanTime(AVL_uint16 Frame_Num, struct AVL62X1_Chip *pAVL_Chip)
{
  ...
  r |= II2C_Write16_AVL62X1(pAVL_Chip->usI2CAddr, c_AVL62X1_SP_S2X_sp_t2mi_mplp_id_scan_time_caddr, Frame_Num); //default value 10
...
{
  AVL_ErrorCode r = AVL_EC_OK;
  AVL_uchar PLP_Num = 0, i = 0;
  AVL_uchar TempPLPID = 0;
  const AVL_uint16 uiTimeDelay = 20;
  const AVL_uint16 uiMaxRetries = 100;
  enum AVL62X1_LockStatus lock_status = AVL62X1_STATUS_UNLOCK;
  enum AVL62X1_DVBStreamType StreamType = AVL62X1_TRANSPORT;
  r |= AVL62X1_GetLockStatus(&lock_status, pAVL_Chip);
  ...
  if ((lock_status == AVL62X1_STATUS_LOCK) && (AVL62X1_T2MI == StreamType))
  {
    do
    {
      r |= II2C_Read8_AVL62X1(pAVL_Chip->usI2CAddr, s_AVL62X1_SP_S2X_sp_t2mi_mplp_id_num_caddr, &PLP_Num);
      if (uiMaxRetries < i++)
      {
        break;
      }
    ...
    if (PLP_Num != 0xff) // scan PLP id done ,and get PLP num and PLP id list
    {
      ...
      {
        r |= II2C_Read8_AVL62X1(pAVL_Chip->usI2CAddr, s_AVL62X1_SP_S2X_sp_mplp_id_list_iaddr + i, &TempPLPID);
...
AVL_ErrorCode AVL62X1_Get_StreamType(enum AVL62X1_DVBStreamType *StreamType, struct AVL62X1_Chip *pAVL_Chip)
{
  AVL_ErrorCode r = AVL_EC_OK;
  AVL_uchar Temp = 0;
  r |= II2C_Read8_AVL62X1(pAVL_Chip->usI2CAddr, s_AVL62X1_SP_S2X_DetectedStreamType_caddr, &Temp);
  *StreamType = (AVL62X1_DVBStreamType)Temp;
